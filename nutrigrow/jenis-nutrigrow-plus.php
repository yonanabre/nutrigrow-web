...
<html>
<head>
	<title>JENIS NUTRIGROW® PLUS</title>
</head>
<body>
	<?php 
			...
			<div class="heading-content heading-align-left" style=" padding:100px">
				<div class="heading-text-wrapper">
					<div class="header_text uk-panel">
						<h1 style="font-size: 40px; color: white; text-transform: uppercase;">JENIS NUTRIGROW® PLUS</h1>
					</div>
				</div>
	...
	<div class="container" style="padding-top: 30px;margin-left: 80px;">
		<div class="row">
			<div class="col-9">
				...
				Jenis Nutrigrow® Plus			</h1>
				<div>
					<p><img src="images/nutrigrow-pertumbuhan.jpg" alt=""></p>
					<p>&nbsp;</p>
					<p><img src="images/nutrigrow-buah-deptan.jpg" alt=""></p>
					<p>&nbsp;</p>
					<p><img src="images/nutrigrow-veg-gen.jpg" alt=""></p>
				</div>
			</div>
			<?php 
		...
		<nav aria-label="breadcrumb" >
			<ol class="breadcrumb"style="padding-left: 100px;">
				...
				<li class="breadcrumb-item active">NUTRIGROW® Plus</li>
				<li class="breadcrumb-item active">Jenis NUTRIGROW® Plus</li>
			</ol>
		</nav>
